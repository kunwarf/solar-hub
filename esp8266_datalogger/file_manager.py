"""
Simple file manager for ESP8266 web interface.
...
class FileManager:
    ...
    # Maximum upload size (bytes) — reduced for ESP8266 (128 KB vs 512 KB on ESP32)
    MAX_UPLOAD_SIZE = 128 * 1024  # 128 KB
    ...
    @staticmethod
    def read_file(filename, max_size=50 * 1024):
        """
        Read file contents.

        Args:
            filename: File to read
            max_size: Maximum bytes to read (default 50 KB, reduced for ESP8266)
