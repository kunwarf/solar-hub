...
def _schedule_to_response(s: ProviderBillingSchedule) -> BillingScheduleResponse:
    return BillingScheduleResponse(
        ...
        fuel_price_adjustment=float(s.fuel_price_adjustment),
        quarterly_tariff_adjustment=float(s.quarterly_tariff_adjustment),
...
async def create_billing_schedule(
    ...
    schedule = ProviderBillingSchedule.create(
        ...
        fuel_price_adjustment=body.fuel_price_adjustment,
        quarterly_tariff_adjustment=body.quarterly_tariff_adjustment,
...
async def update_billing_schedule(
    ...
    schedule.update(
        ...
        fuel_price_adjustment=body.fuel_price_adjustment if body.fuel_price_adjustment is not None else schedule.fuel_price_adjustment,
        quarterly_tariff_adjustment=body.quarterly_tariff_adjustment if body.quarterly_tariff_adjustment is not None else schedule.quarterly_tariff_adjustment,
