"""
Minimal HTTP POST utility for MicroPython.

Extracted from modbus_bridge.py so that serial_bridge.py can import only
this one function without loading the entire 400-line ModbusBridge class.
"""
import json
import socket
